...
import { doc, getDoc, getFirestore, collection, setDoc, addDoc, updateDoc, query, where, getDocs, onSnapshot } from 'firebase/firestore';
...
function CreateJoinTeam() {
  ...
  useEffect(() => {
    ...
    getDoc(usersDocRef).then(doc => {
      if (doc.data().team !== "") navigate('/recon/manage-team')
    });
